...
Usage
---------------------
To build a simple [nodejs-sample-app](https://github.com/getupcloud/sti-nodejs/tree/master/5.9/test/test-app) application
using standalone [STI](https://github.com/openshift/source-to-image) and then run the
resulting image with [Docker](http://docker.io) execute:

*  **For CentOS based image**
    ```
    $ s2i build https://github.com/getupcloud/sti-nodejs.git --context-dir=5.9/test/test-app/ getupcloud/nodejs-59-centos7 nodejs-sample-app
